 ...
 *  Version x1.10
 *  Modified PADSASC0.C version 1.10c to work with PADS 2000
 *      - Changed allowable length of node names from 12 to 47
 *      - Added closing asterisk on keywords
 ...
 *      - Node Names are limited to 47 characters
